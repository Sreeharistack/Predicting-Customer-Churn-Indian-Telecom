...
The model-comparison results show that tuned Logistic Regression achieved the highest test F1-score, performing marginally better than the base Logistic Regression model.
...
The training and test performance are very similar, suggesting good generalization on the held-out test data in this experiment.
